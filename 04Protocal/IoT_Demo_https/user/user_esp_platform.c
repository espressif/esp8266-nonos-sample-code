...
LOCAL os_timer_t ssl_ntp_timer;
...
// #ifdef UPGRADE_SSL_ENABL
//     bool ret = configTime(8,0,"pool.ntp.org",NULL,NULL,false);
//     if(ret == false) {
//         ESP_DBG("get time failed\n");
//         return;
//     }
//     static time_t systime  = 0;
//     systime = time(&systime);

//     os_timer_disarm(&ssl_ntp_timer);
//     os_timer_setfn(&ssl_ntp_timer, (os_timer_func_t *)ssl_upgrade_begin_cb, NULL);
//     if(systime == 0) {
//         os_timer_arm(&ssl_ntp_timer, 10, 0);
//     }
// #endif
